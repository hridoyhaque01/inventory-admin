              ...
              <div className="flex flex-col justify-start gap-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-3">
                  ...
                  <input
                    ...
                    name="productId"
                    className="w-full py-3 px-4 text-fadeColor border border-whiteLow outline-none rounded text-sm sm:text-base bg-whiteMid"
                    readOnly
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-3">
                  ...
                  <div className="w-full py-3 px-4 flex items-center border border-whiteLow outline-none rounded text-fadeColor text-sm sm:text-base bg-whiteMid">
                    <input
                      type="number"
                      name="quantity"
